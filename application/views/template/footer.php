...
<footer class="footer">
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; 2021 <a class="font-weight-bold ml-1" target="_blank">PT Yodya Karya (Persero)</a>
            </div>
          </div>
        </div>
      </footer>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $('.masking').mask('000.000.0000');
    });
  <!-- <script src="https://cdnjs.cloudflare.com/ajac/libs/jquery.mask/1.."></script> -->
