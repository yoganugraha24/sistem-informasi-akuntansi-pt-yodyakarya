...
<head>
    ...
    <title>PT Yodya Karya (Persero) | Login</title>
    <!-- Favicon -->
...
<body class=""
    style="background-image: url('assets/img/brand/karyaa.jpg'); background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-7">
                    <div class="card bg-secondary shadow-lg border-0">
                        ...
                        <div class="bg-gradient-green card-body px-lg-5 py-lg-5">
                            <div class="text-center text-muted mb-4">
                                <img src="<?= base_url('assets/img/theme/persero.jpg') ?>" class="navbar-brand-img"
                                    alt="...">
                            </div>
