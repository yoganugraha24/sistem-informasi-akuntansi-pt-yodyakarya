              ...
              <div class="col mb-5 mb-xl-0">
                  <div class="card shadow">
                      <div class="card-header border-0">
                          ...
                          <div class="row">
                              <div class="col my-3">
                                  <a href="<?= base_url('jurnal_umum/tambah') ?>" class="btn btn-primary mt-2">Tambah
                                      Jurnal</a>
                                  <a href="<?= base_url('jurnal_umum/cetak') ?>" class="btn btn-primary mt-2">Cetak
                                      Pdf</a>
                              </div>
                              <div class="col my-3">
                                  <form action="<?= base_url('jurnal_umum/detail') ?>" method="post"
