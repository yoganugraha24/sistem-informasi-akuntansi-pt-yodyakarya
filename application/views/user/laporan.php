...
<body>
    <h3 class="text-center">Laporan Bulan <?= bulan($bulan) ?>  <?= $tahun ?></h3>
    <hr>
    <h3 class="m-fix text-center">Piutang Jasa Konsultan</h3>
    <table class="mb-fix">
    ...
    <h3 class="m-fix text-center" style="margin-top:10px">Jurnal Umum</h3>
    <table class="mb-fix">
        <tr class="text-center font-bold">
            <td>No.</td>
            <td>Tanggal</td>
        ...
        <tr  class="text-center bg-danger ">
            <td colspan="6" class="text-white" style="font-weight:bolder;font-size:14px">TIDAK SEIMBANG</td>
        </tr>
        <?php }else{  ?>
        <tr>
        ...
        <tr class="text-center bg-success">
            <td colspan="6" class="text-white" style="font-weight:bolder;font-size:14px">SEIMBANG</td>
        </tr>
        <?php } ?>
    </table>
