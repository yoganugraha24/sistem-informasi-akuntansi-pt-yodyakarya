                      ...
                      <div class="card-header border-0">
                          <div class="row align-items-center">
                              ...
                              <div class="col-12 my-3">
                                  <a href="<?= base_url('data_akun/tambah') ?>" class="btn btn-primary mt-2">Tambah
                                      Akun</a>
                                  <a href="<?= base_url('data_akun/cetak') ?>" class="btn btn-primary">Cetak Pdf</a>
                              </div>
                          </div>
                      </div>
                  ...
                  ?>
                      ...
                      ?>
                                      ...
                                      <td class="d-flex justify-content-center">
                                          <a href="<?= base_url('data_akun/edit/'.$row->no_reff) ?>"
                                              class="btn btn-warning mb-4">Edit</a>
